...
(setq user-full-name "Naoki Nakadate"
      user-mail-address "nnaka2992@gmail.com")
...
(after! ddskk-postframe
  (add-hook 'global-minor-modes #'ddskk-postgrame-mode))
